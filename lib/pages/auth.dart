...
class _AuthPageState extends State<AuthPage> with TickerProviderStateMixin {
  ...
  final TextEditingController _passwordTextController =
      new TextEditingController();
  final TextEditingController _confirmEmailTextController =
      new TextEditingController();
  ...
  void _onSubmit(MainModel model) async {
    ...
    if (validationSuccess &&
        (_authMode == AuthMode.Login || _formData['agreedToTerms'])) {
              ...
              return AlertDialog(
                ...
                actions: <Widget>[
                  FlatButton(
                    child: Text('Okay'),
                    onPressed: () =>
                        Navigator.of(context).pop(), // Remove the alert
                  )
                ],
              );
            });
  ...
  Widget build(BuildContext context) {
    ...
    final Widget confirmEmailWidget = _buildTextField(
        'Confirm Email', (String change) => _formData['confirmEmail'] = change,
        (String value) {
      if (value != _emailTextController.text && _authMode == AuthMode.Register) {
        return 'Emails do not match';
      }
    },
        keyboardType: TextInputType.emailAddress,
        controller: _confirmEmailTextController);
    final Widget confirmPasswordWidget = _buildTextField('Confirm Password',
        (String change) => _formData['confirmPassword'] = change,
        (String value) {
      if (value != _passwordTextController.text && _authMode == AuthMode.Register) {
